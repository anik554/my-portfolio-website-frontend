...
export default function Card3dDemo({ project }: IProps) {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      const transforms = updateCardTransform(
      ...
      if (transforms) {
        ...
        card.style.transform = `
          ...
          scale3d(${cardTransform.scale}, ${cardTransform.scale}, ${cardTransform.scale})
        `;
        ...
        image.style.transform = `
          ...
          scale3d(${imageTransform.scale}, ${imageTransform.scale}, ${imageTransform.scale})
        `;
      }
  ...
  return (
    <Card ref={cardRef} className="max-w-md cursor-pointer select-none">
      <CardHeader>
